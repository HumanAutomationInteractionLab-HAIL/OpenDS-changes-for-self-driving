...
public class SimulatorActionListener implements ActionListener {
	...
	public void onAction(String binding, boolean value, float tpf) {
		if (binding.equals(KeyMapping.STEER_LEFT.getID())) {
			...
			// If the participant starts turning the wheel, autopilot will be turned off. Same for braking/accelerating as you can see later in this file
